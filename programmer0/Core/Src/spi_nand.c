...
/* SPI NAND命令集 */
#define _SPI_NAND_OP_GET_FEATURE                0x0F    /* 获取特性 */
#define _SPI_NAND_OP_SET_FEATURE                0x1F    /* 设置特性 */
#define _SPI_NAND_OP_PAGE_READ                  0x13    /* 将页数据加载到SPI NAND芯片的缓存中 */
#define _SPI_NAND_OP_READ_FROM_CACHE_SINGLE     0x03    /* 从SPI NAND芯片的缓存中读取数据，单速度 */
#define _SPI_NAND_OP_READ_FROM_CACHE_DUAL       0x3B    /* 从SPI NAND芯片的缓存中读取数据，双速度 */
#define _SPI_NAND_OP_READ_FROM_CACHE_QUAD       0x6B    /* 从SPI NAND芯片的缓存中读取数据，四速度 */
#define _SPI_NAND_OP_WRITE_ENABLE               0x06    /* 启用将数据写入SPI NAND芯片 */
#define _SPI_NAND_OP_WRITE_DISABLE              0x04    /* 复位写使能锁存器（WEL） */
#define _SPI_NAND_OP_PROGRAM_LOAD_SINGLE        0x02    /* 将数据写入带有缓存复位的SPI NAND芯片的缓存，单速度 */
#define _SPI_NAND_OP_PROGRAM_LOAD_QUAD          0x32    /* 将数据写入带有缓存复位的SPI NAND芯片的缓存，四速度 */
#define _SPI_NAND_OP_PROGRAM_LOAD_RAMDOM_SINGLE 0x84    /* 将数据写入SPI NAND芯片的缓存，单速度 */
#define _SPI_NAND_OP_PROGRAM_LOAD_RAMDON_QUAD   0x34    /* 将数据写入SPI NAND芯片的缓存，四速度 */
#define _SPI_NAND_OP_PROGRAM_EXECUTE            0x10    /* 将缓存中的数据写入SPI NAND芯片 */
#define _SPI_NAND_OP_READ_ID                    0x9F    /* 读取制造商ID和设备ID */
#define _SPI_NAND_OP_BLOCK_ERASE                0xD8    /* 擦除块 */
#define _SPI_NAND_OP_RESET                      0xFF    /* 复位 */
#define _SPI_NAND_OP_DIE_SELECT                 0xC2    /* 选择Die */
/* SPI NAND命令集的寄存器地址 */
#define _SPI_NAND_ADDR_ECC                      0x90    /* ECC配置的地址 */
#define _SPI_NAND_ADDR_PROTECT                  0xA0    /* 保护的地址 */
#define _SPI_NAND_ADDR_FEATURE                  0xB0    /* 特性的地址 */
#define _SPI_NAND_ADDR_STATUS                   0xC0    /* 状态的地址 */
#define _SPI_NAND_ADDR_FEATURE_4                0xD0    /* 状态4的地址 */
#define _SPI_NAND_ADDR_STATUS_5                 0xE0    /* 状态5的地址 */
#define _SPI_NAND_ADDR_MANUFACTURE_ID           0x00   /* 制造商ID的地址 */
#define _SPI_NAND_ADDR_DEVICE_ID                0x01    /* 设备ID的地址 */
/* SPI NAND命令集的寄存器地址的值 */
#define _SPI_NAND_VAL_DISABLE_PROTECTION        0x0     /* 禁用写保护的值 */
#define _SPI_NAND_VAL_ENABLE_PROTECTION         0x38    /* 启用写保护的值 */
#define _SPI_NAND_VAL_OIP                       0x1     /* OIP = 操作正在进行中 */
#define _SPI_NAND_VAL_ERASE_FAIL                0x4     /* 擦除失败 */
#define _SPI_NAND_VAL_PROGRAM_FAIL              0x8     /* 编程失败 */
